...
//    assert(memory_dump(computer5) == "2 3 3 0 ");
    ...
    auto ooasm_bigger = program({
        ...
        mov(mem(lea("DDDDDDDDDD")), num(9)), // 1 1 7 9 1
        add(mem(lea("aaaaaaaaaa")), mem(lea("bbbbbbbbbb"))),
        sub(mem(lea("aaaaaaaaaa")), mem(lea("eeeeeeeeee"))), // 1 1 7 9 1
        add(mem(lea("aaaaaaaaaa")), mem(lea("DDDDDDDDDD"))),
        sub(mem(lea("aaaaaaaaaa")), mem(lea("cccccccccc"))), // 3 1 7 9 1
        add(mem(lea("aaaaaaaaaa")), mem(lea("DDDDDDDDDD"))),
        sub(mem(lea("aaaaaaaaaa")), mem(lea("cccccccccc"))), // 5 1 7 9 1
        add(mem(lea("aaaaaaaaaa")), mem(lea("DDDDDDDDDD"))),
        sub(mem(lea("aaaaaaaaaa")), mem(lea("cccccccccc"))), // 7 1 7 9 1
    ...
    computer6.memory_dump(std::cout);

//    assert(memory_dump(computer6) == "7 7 7 9 1 ");
    ...
    auto ooasm_flags = program({
        ...
        data("6", num(-5)),
        data("7", num(-6)),
        onez(mem(lea("1"))), // 1 -1 -2 -3 -4 -5 -6 
        ones(mem(lea("2")))
    });
    Computer computer7(7);
    computer7.boot(ooasm_flags);
//    assert(memory_dump(computer7) == "1 -1 -2 -3 -4 -5 -6 ");
